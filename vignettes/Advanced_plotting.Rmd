...
# make variables grid
WI_var_grid <- expand_grid(model = WI_mods$func, spawn.date = WI_spawn_dates)
...
# variable grid
var_grid <- expand_grid(model = dev_mods$func, spawn.date = spawn_dates)
...
spawn_grid <- expand_grid(model = dev_mods$func, spawn.date = fish_dates_str)
