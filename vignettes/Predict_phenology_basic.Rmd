...
> Note the warning message that appears when you run this code for `woody_island`. It reveals that while the fish develoeped, negative temperature values resulted in NaNs after development. More on this in the [Negative Temperature]{#neg_temp} section.
...
-   `WI_hatch$model` is a tibble showing the model specifications used to predict the phenology.

## Vizualizing phenology
