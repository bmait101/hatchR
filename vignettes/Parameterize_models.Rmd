...
You can either pass this tibble directly with the `$` operator by calling `$func` element of the list (e.g., `model = bt_fit$func`) or set as an object to pass, like so:
