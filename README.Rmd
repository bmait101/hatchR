...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/hatchR)](https://CRAN.R-project.org/package=hatchR)
...
Install the development version of **hatchR** from [GitHub](https://github.com/) by running:
...
You can also use the **hatchR** Shiny app to interactively predict fish developmental phenology. To run the app, visit the [hatchR Shiny app](https://elifelts.shinyapps.io/hatchR_demo/).
