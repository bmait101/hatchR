...
#   library(DiagrammeR)
#   #see https://rpubs.com/anshulkumar/FlowchartsInR
#   grViz("digraph {
#
#       # a 'graph' statement
...
#       # label nodes
#       node [fontsize = 20]
#       import [label = 'import data', shape = circle, fillcolor = Beige]
#       dates [label = 'check dates', shape = circle, fillcolor = Beige]
#       plot1 [label = 'plot_check_data()' shape = rectangle]
#       format [label = 'is data as\ndaily average?', shape = circle, fillcolor = Beige]
#       plot2 [label = 'plot_check_data()' shape = rectangle]
#       summarize [label = 'sumamrize_temp()',  shape = rectangle]
#       model [label = 'model type:\ncustom or included?', shape = circle, fillcolor = Beige]
...
#       summarize -> plot2 -> model
#       model -> select [label = 'hatchR built in model']
