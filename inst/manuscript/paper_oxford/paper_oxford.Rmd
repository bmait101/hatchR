...
address:
  - code: A
    ...
    #postcode: 
    city: Boise
    state: Idaho # Mix and match elements to get proper address
    country: United States
  - code: B
    department: Idaho Fish and Wildlife Conservation Office
...
author_contributions: |
  MMS and BMM designed and wrote the package. EF wrote the Shiny app. All authors wrote and edited the manuscript.
acknowledgments: |
...
bibliography: ms_refs.bib # Includes refs in OUP example template
