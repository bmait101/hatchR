...
![Densities of predicted days to hatch for Bull Trout for 139 putative spawning locations across Idaho for four years of shared temperature data. Early spawning considers if a parent spawned September 1, Peak-September 15, and Late-September 30.](paper_files/figure-latex/unnamed-chunk-19-1.pdf) 
...
talk about how temperatures may not always reflect redd temperture

talk about how other factors like oxygen or predator cues may change phenology

talk about how these models could be extended for other development phases or to organisms that fit similar developmental patterns

talk about how advanced users could fit their own models and provide their custom expression to predict_phenology for a really customized option.
