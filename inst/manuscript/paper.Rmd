...
To predict hatch timing across these sites, we first set up the necessary models and data, using Bull Trout parameterization. (For conciseness, we omit this set up here, but full details are available in the `paper.Rmd` file in the GitHub repository for **hatchR**.) We then apply `predict_phenology()` across all 139 sites, running predictions for three representative spawn dates (Early: September 1st, Peak: September 15th, Late: September 30th).
