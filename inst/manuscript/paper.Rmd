...
temps_sim <- sort(rnorm(n =30, mean = 16, sd = 1), decreasing = TRUE)
...
### catfish example from Small and Bates 2001
### Effect of Low-Temperature Incubation of Channel Catfish Ictalarus punctatus
### Eggs on Development, Survival, and Growth
...
### lake sturgeon mod
### Smith and King 2005
### Dynamics and extent of larval lake sturgeon Acipenser fulvescens drift in the 
### Upper Black River, Michigan
...
sturgeon_mod <- fit_model(df = sturgeon,
                          days = sturgeon$days,
...
catfish_res$days2done; sturgeon_res$days2done
```
