...
**Table 1.** Example temperature data for use in hatchR.
...
**Box 5.** Output of `plot_phenolgy()` function using predicted hatch time from `woody_island` dataset.
