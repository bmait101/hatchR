...
^3^Forest Ecosystems and Society, Oregon State University, Corvallis, OR, USA
...
To predict hatch timing across these sites, we first set up the necessary models and data, using the built-in Bull Trout parameterization. We then iterate `predict_phenology()` across all 139 sites, running predictions for three representative spawn dates each year (Early: September 1st, Peak: September 15th, Late: September 30th).
...
-   <div>
    ...
    figure_3 <- ggplot(
      ...
      geom_density_ridges(alpha = 0.9, scale = .99,
...
**hatchR** is fully open source and reproducible. Source code and data can be found at <https://github.com/bmait101/hatchR/>. The Rmardkdown document with all the code to reproduce the examples from this manuscript is available at <https://github.com/bmait101/hatchR/blob/master/inst/manuscript/paper.Rmd>. The software and manuscript versions associated with the accepted manuscript are archived on the Releases page of the software GitHub (<https://github.com/bmait101/hatchR/releases>).
